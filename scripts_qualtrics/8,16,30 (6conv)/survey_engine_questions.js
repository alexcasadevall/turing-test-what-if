Qualtrics.SurveyEngine.addOnload(function() {
    ...
    function getIframeDoc() {
        try {
            ...
            console.log("Avís: Escut actiu. Evitem que el mòbil es congeli si no troba el botó a la primera.");
        }
        return null;
    }
    ...
    function bloquejarBoto() {
        ...
        if (!document.getElementById('scroll-warning')) {
            ...
            var btnElement = getNextButton();
            if (btnElement && btnElement.parentNode) {
                btnElement.parentNode.insertBefore(msg, btnElement);
            }
        }
    }
